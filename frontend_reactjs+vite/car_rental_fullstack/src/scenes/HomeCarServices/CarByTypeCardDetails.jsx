...
import img2 from "../global/imagesandvideo/sedan.jpg";
import img3 from "../global/imagesandvideo/suv.jpg";
...
const CarByTypeCardDetails = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:8080/getCarByType/${cartype}`)
      .then((res) => {
        console.log(res);
        setCardata(res.data);
      })
  ...
  return (
    <>
      ...
      >
        ...
        >
          <h2 className="text-white text-4xl font-bold">{cartype}</h2>
...
export default CarByTypeCardDetails;
